...
public class VacuumState extends State {
	...
	/** Return a random initial state for the vacuum world. The agent's
   	initial location, dirt locations and other obstacles are random. This 
   	method fills in areas that are impossible to reach with walls. 
   */
	 ...
	 * seed.  The agent's initial location, dirt locations and other obstacles 
	 * are random. This method fills in areas that are impossible to reach with 
	 * walls. */
   public static VacuumState getRandomState(int randSeed) {
	 ...
	 * state for the vacuum world.  The agent's initial location, dirt locations 
	 * and other obstacles are random. This method fills in areas that are 
	 * impossible to reach with walls. */
